...
data_file=open('data_wa/random2_data_train.pickle', "rb")
label_file=open('data_wa/random2_label_train.pickle', "rb")
    ...
    if args.train:
        ...
        for eps in range(training_episodes):
            ...
            if eps % 100 ==0:
                ...
                plt.savefig('classify_trainwithdataobj_wa.png')
                classifier.save(model_path)
        np.savetxt('trainwithdata_wa.txt', np.array(loss_list)[:, np.newaxis], fmt='%.4f', newline=', ')
...
# test with testing dataset, all at once
    if args.test:
        # data_file=open('data_wa/data_train.pickle', "rb")
        # label_file=open('data_wa/label_train.pickle', "rb")
        # data_file=open('data_wa/data_test.pickle', "rb")
        # label_file=open('data_wa/label_test.pickle', "rb")
        # data_file=open('data_wa/random_data_test.pickle', "rb")
        # label_file=open('data_wa/random_label_test.pickle', "rb")
        data_file=open('data_wa/random2_data_test.pickle', "rb")
        label_file=open('data_wa/random2_label_test.pickle', "rb")
