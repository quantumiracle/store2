...
if __name__ == '__main__':
    model_path = './model/class_obj_rotat'
    ...
    if args.train:
        ...
        for eps in range(training_episodes):
            ...
            if eps % 100 ==0:
                ...
                plt.savefig('classify_trainwithdataobj_rotat.png')
                classifier.save(model_path)
        
        np.savetxt('trainwithdata_rotat.txt', np.array(loss_list)[:, np.newaxis], fmt='%.4f', newline=', ')
